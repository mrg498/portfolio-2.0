    ...
    <div id="projects" className={projectStyles.container}>
      <h2 className={projectStyles.title}>
        ...
        <h5 className={projectStyles.subTitle}>
          For more, see my pinned <a href="https://github.com/mrg498">github</a>{" "}
          repos
        </h5>
      </h2>
      <div className={projectStyles.postContainer}>
        <div className={projectStyles.row}>
          <div className={projectStyles.post}>
            ...
            <div className={projectStyles.sectionWrapper}>
              <div className={projectStyles.sectionGroup}>
                <a
                  href="https://chandrikatandon.com/"
          ...
          <div className={projectStyles.post}>
            ...
            <p>
              An internal tool for partnered Handoff retailers to manage
              inventory, track transactions, and handle customer orders. I was
              solely responsible for implementing the customer order handling
              and order history components.
            </p>
            <div className={projectStyles.sectionWrapper}>
              <div className={projectStyles.sectionGroup}>
                <a
                  href="https://www.youtube.com/watch?v=b4ZVpL89uEg"
                  className={projectStyles.btn}
                >
                  Demo
                </a>
        ...
        <div className={projectStyles.row}>
          <div className={projectStyles.post}>
            ...
            <p>
              ...
              submit to playlists for track placement. I served as the main
              front end developer, but I was also involved in writing parts of
              the backend, and now I handle front end and back end updates to
              the site as needed. Over 6,000 users signed up and ~$2000 monthly
              revenue generated.
            </p>
            <div className={projectStyles.sectionWrapper}>
              <div className={projectStyles.sectionGroup}>
                <a
                  href="https://analogcollective.com/"
                  className={projectStyles.btn}
                >
                  Live
                </a>
          ...
          <div className={projectStyles.post}>
            ...
            <p>
              A personal project I am developing that allows creators to upload
              written and spoken word fiction for purchase.
            </p>
            <div className={projectStyles.sectionWrapper}>
              <div className={projectStyles.sectionGroup}>
                <a
                  href="https://github.com/mrg498/haven"
                  className={projectStyles.btn}
                >
                  Code
                </a>
          ...
          <div className={projectStyles.post}>
            ...
            <p>
              A personal project I built to pull Chloe Ting exercise videos from
              youtube and build unique workouts. Interfaces with the youtube
              API.
            </p>
            <div className={projectStyles.sectionWrapper}>
              <div className={projectStyles.sectionGroup}>
                <a
                  href="https://mrg498.github.io/chloe-ting-react-app/"
                  className={projectStyles.btn}
                >
                  Live
                </a>
                <a
                  href="https://github.com/mrg498/chloe-ting-react-app"
                  className={projectStyles.btn}
                >
                  Code
                </a>
          ...
          <div className={projectStyles.post}>
            ...
            <div className={projectStyles.sectionWrapper}>
              <div className={projectStyles.sectionGroup}>
                <a
                  href="https://github.com/Splash-Kid-iOS/splash-kid"
                  className={projectStyles.btn}
                >
                  Code
                </a>
